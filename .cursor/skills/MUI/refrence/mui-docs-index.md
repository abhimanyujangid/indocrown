...
- [Menubar React component](https://mui.com/material-ui/react-menubar.md): A React component for building accessible application menus.
...
- [Material UI Versions](https://mui.com/material-ui/getting-started/versions.md): You can come back to this page and switch the version of the docs you're reading at any time.
...
- [Upgrade to v9](https://mui.com/material-ui/migration/upgrade-to-v9.md): This guide explains how to upgrade from Material UI v7 to v9.
